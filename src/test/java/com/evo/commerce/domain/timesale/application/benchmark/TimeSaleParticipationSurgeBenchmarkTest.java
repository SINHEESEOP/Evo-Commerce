...
class TimeSaleParticipationSurgeBenchmarkTest {
    ...
    @Disabled("ISSUE-32: RLock tryLock 대기시간 초과로 정원의 극히 일부만 채워짐 - 3.11 원자적 Redis 연산 재설계 후 재활성화 예정")
    @Test
    void Redis_분산_락_방식은_지원자가_정원보다_훨씬_많아도_정원까지는_모두_성공한다() throws InterruptedException {
